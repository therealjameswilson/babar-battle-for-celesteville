...
let fortified=false,deployed=false;
...
console.log(JSON.stringify({difficulty:'Commander',opening:'defensive',fortified,deployed,...result}));
assert(fortified&&deployed,'Defensive strategy must build fortifications and deploy artillery');
