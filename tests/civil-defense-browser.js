...
for(const [w,h] of [[390,844],[844,390],[1280,900]]){
 ...
 g.eval("reset();running=true;paused=false;nextWave=enemySpawn=1e9;selected=[alive(0).find(u=>u.type==='worker')];ore=1000;materials=200;technologies.add('damageLimitation');cam.x=490;cam.y=1010;cam.zoom=1;updateUI(true)");
