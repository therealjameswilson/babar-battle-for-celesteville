...
| Construction and production | Worker-built structures, paid queues, cancellation, rally, control groups | Guard School gates Artillery Works; dual-resource costs, multi-producer allocation and housing-raid production blocks implemented; two-tier infantry protection now competes with weapons and recruitment; researched infantry burst now adds a health-for-tempo micro decision; broader build-order comparisons remain |
| Army composition | Guards, scouts, artillery, commanders; research and abilities | Sappers counter armored guns/structures and guards counter sappers; four composition scenarios recorded. Latest movement checks: siege rush loses Commander, mixed and fortified openings win in local scripted scenarios. Eight controlled burst comparisons now verify health-for-tempo tradeoffs (BURST-COMPARISON.md); six paid doctrine openings now record research opportunity cost (DOCTRINE-OPENINGS.md); second-school research and human balance comparisons remain |
