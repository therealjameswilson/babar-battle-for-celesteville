...
## v0.52.0
Civil Defense construction now requires the faction's damageLimitation technology.
Guard School research: 150 S / 50 M / 40s. Both UI and simulation placement enforce
